        ...
        if (activeTab === 'today' && todayData.calories > 0) {
            ...
            if (shouldRefresh && !loadingExplanation) {
                ...
                explainDietScore(
                    ...
                    setAiExplanation('AI insights unavailable right now. Check your Gemini API key.');
                    setLoadingExplanation(false);
                });
            }
        }
                        ...
                        {weeklyLoading ? (
                            ...
                            <View style={[styles.emptyState, { backgroundColor: theme.card, borderColor: theme.border }]}>
                                ...
                                <TouchableOpacity
                                    ...
                                    style={{ marginTop: 12, paddingHorizontal: 20, paddingVertical: 10, backgroundColor: theme.primary, borderRadius: 10 }}
                                >
